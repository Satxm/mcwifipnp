...
public class ForceOfflineCommand {
  private static final SimpleCommandExceptionType ERROR_ALREADY_IN = new SimpleCommandExceptionType(new TranslatableComponent("mcwifipnp.commands.forceoffline.add.failed"));
  private static final SimpleCommandExceptionType ERROR_NOT_IN = new SimpleCommandExceptionType(new TranslatableComponent("mcwifipnp.commands.forceoffline.remove.failed"));
  ...
  commandSourceStack.sendSuccess(new TranslatableComponent("mcwifipnp.commands.forceoffline.add.success",
  ...
  while(var4.hasNext()) {
    ...
    MCWiFiPnPUnit.saveConfig(cfg);
  commandSourceStack.sendSuccess(new TranslatableComponent("mcwifipnp.commands.forceoffline.remove.success",
    new Object[] { ComponentUtils.getDisplayName(gameProfile) }), true);
    ++i;
    }
  }
  ...
  if (ForceOfflinePlayers.size() == 0) {
    commandSourceStack.sendSuccess(new TranslatableComponent("mcwifipnp.commands.forceoffline.none"), false);
  } else {
    commandSourceStack.sendSuccess(new TranslatableComponent("mcwifipnp.commands.forceoffline.list", 
