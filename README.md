...
**For Minecraft 1.17-21w20a**

**Requires [Fabric API](https://www.curseforge.com/minecraft/mc-mods/fabric-api) and [Fabric Loader](https://fabricmc.net/use/)**

Use vanilla Minecraft Screen Style.

Modify from [TheGlitch76/mcpnp](https://github.com/TheGlitch76/mcpnp) , UPnP module from [adolfintel/WaifUPnP](https://github.com/adolfintel/WaifUPnP)

## Some pictures of LAN World Screen.
