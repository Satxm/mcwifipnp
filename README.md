...
**这个分支仅适用于 Minecraft 版本 1.15.2 ！**

Updated to Minecraft 1.15.2, Uses the vanilla Minecraft GUI style, Uses the official mojang mappings.

已经更新到1.15.2，使用Minecraft原生界面样式，使用Mojang官方混淆表。
