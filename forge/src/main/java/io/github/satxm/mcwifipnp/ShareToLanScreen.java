...
public class ShareToLanScreen extends Screen {
    ...
    protected void init() {
        ...
        this.EditPort = new TextFieldWidget(this.font, this.width / 2 - 154, 66, 96, 20, new StringTextComponent(Integer.toString(cfg.port)));
        ...
        this.EditPlayers = new TextFieldWidget(this.font, this.width / 2 - 48, 66, 96, 20, new StringTextComponent(Integer.toString(cfg.maxPlayers)));
        ...
        this.EditMotd = new TextFieldWidget(this.font, this.width / 2 + 58, 66, 96, 20, new StringTextComponent(cfg.motd));
    ...
    public void render(MatrixStack poseStack, int i, int j, float f) {
        ...
        drawString(poseStack, this.font, new TranslationTextComponent("mcwifipnp.gui.port"), this.width / 2 - 149, 54, 16777215);
        drawString(poseStack, this.font, new TranslationTextComponent("mcwifipnp.gui.players"), this.width / 2 - 43, 54, 16777215);
        drawString(poseStack, this.font, new TranslationTextComponent("mcwifipnp.gui.motd"), this.width / 2 + 63, 54, 16777215);
        drawString(poseStack, this.font, new TranslationTextComponent("mcwifipnp.gui.port." + this.portinfo), this.width / 2 - 150, 88, -6250336);
        drawString(poseStack, this.font, new TranslationTextComponent("mcwifipnp.gui.players.info"), this.width / 2 - 43, 88, -6250336);
        drawString(poseStack, this.font, new TranslationTextComponent("mcwifipnp.gui.motd.info"), this.width / 2 + 63, 88, -6250336);
        ...
        drawString(poseStack, this.font, new TranslationTextComponent("mcwifipnp.gui.CopyIP.info"), this.width / 2 + 10, 186, -6250336);
