...
public class ShareToLanScreen extends Screen {
    ...
    protected void init() {
        this.StartLanServer = this.addButton(new Button(this.width / 2 - 155, this.height - 28, 150, 20,
                I18n.format("lanServer.start"), (button) -> {
        ...
        this.addButton(
                new Button(this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel"), (button) -> {
                    this.minecraft.displayGuiScreen(this.lastScreen);
                }));

        this.GameModeButton = (Button) this.addButton(
                new Button(this.width / 2 - 155, 32, 150, 20, I18n.format("selectWorld.gameMode"), (button) -> {
        ...
        this.AllowCommandsButton = (Button) this.addButton(
                new Button(this.width / 2 + 5, 32, 150, 20, I18n.format("selectWorld.allowCommands"), (button) -> {
        ...
        this.OnlineModeButton = (Button) this.addButton(
                new Button(this.width / 2 - 155, 130, 150, 20, I18n.format("mcwifipnp.gui.OnlineMode"), (button) -> {
                    cfg.OnlineMode = !cfg.OnlineMode;
                    this.updateSelectionStrings();
                }));

        this.EnablePvPButton = (Button) this.addButton(
                new Button(this.width / 2 + 5, 130, 150, 20, I18n.format("mcwifipnp.gui.EnablePvP"), (button) -> {
                    cfg.EnablePvP = !cfg.EnablePvP;
                    this.updateSelectionStrings();
                }));

        this.UseUPnPButton = (Button) this.addButton(
                new Button(this.width / 2 - 155, 164, 150, 20, I18n.format("mcwifipnp.gui.UseUPnP"), (button) -> {
                    cfg.UseUPnP = !cfg.UseUPnP;
                    this.updateSelectionStrings();
                }));

        this.CopyToClipboardButton = (Button) this.addButton(
                new Button(this.width / 2 + 5, 164, 150, 20, I18n.format("mcwifipnp.gui.CopyIP"), (button) -> {
    ...
    private void updateSelectionStrings() {
        this.GameModeButton.setMessage(
                I18n.format("selectWorld.gameMode") + ": " + I18n.format("selectWorld.gameMode." + cfg.GameMode));
        this.AllowCommandsButton.setMessage(I18n.format("selectWorld.allowCommands") + ' '
                + I18n.format(cfg.AllowCommands ? "options.on" : "options.off"));
        this.OnlineModeButton.setMessage(I18n.format("mcwifipnp.gui.OnlineMode") + ": "
                + I18n.format(cfg.OnlineMode ? "options.on" : "options.off"));
        this.EnablePvPButton.setMessage(I18n.format("mcwifipnp.gui.EnablePvP") + ": "
                + I18n.format(cfg.EnablePvP ? "options.on" : "options.off"));
        this.UseUPnPButton.setMessage(
                I18n.format("mcwifipnp.gui.UseUPnP") + ": " + I18n.format(cfg.UseUPnP ? "options.on" : "options.off"));
        this.CopyToClipboardButton.setMessage(I18n.format("mcwifipnp.gui.CopyIP") + ": "
                + I18n.format(cfg.CopyToClipboard ? "options.on" : "options.off"));
    }
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawString(this.font, I18n.format("mcwifipnp.gui.port." + this.portinfo), this.width / 2 - 150, 88,
                -6250336);
        ...
        this.drawString(this.font, I18n.format("mcwifipnp.gui.EnablePvP.info"), this.width / 2 + 10, 152, -6250336);
        this.drawString(this.font, I18n.format("mcwifipnp.gui.UseUPnP.info"), this.width / 2 - 150, 186, -6250336);
        this.drawString(this.font, I18n.format("mcwifipnp.gui.CopyIP.info"), this.width / 2 + 10, 186, -6250336);
